<template>
  <section class="sidebar-addkanji">
    <a-button @click="showDrawer" class="btn-addkanji background" type="primary"><a-icon type="plus" />Thêm</a-button>
    <a-drawer
      title="Thêm Kanji"
      :width="720"
      @close="onClose"
    ...
    >
      ...
      >
        ...
        <a-button class="btn-addEnglish background" @click="handleAdd" type="primary"><a-icon type="plus" />Thêm</a-button>
      </div>
    </a-drawer>
  </section>
</template>
