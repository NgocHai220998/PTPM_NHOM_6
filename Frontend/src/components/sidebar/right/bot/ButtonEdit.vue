<template>
  <section class="sidebar-editkanji">
    <a-button @click="showDrawer" class="btn-editkanji background-edit" type="primary"><a-icon type="form" />Sửa</a-button>
    <a-drawer
      title="Sửa Kanji"
      :width="720"
    ...
    >
      ...
      >
        ...
        <a-button :class="isHiden ? 'disabledBox' : ''" class="btn-addEnglish background" @click="handleEdit" type="primary"><a-icon type="plus" />Thêm</a-button>
      </div>
    </a-drawer>
  </section>
</template>
